...
//     print("sederiddi $senderId receiveriddi $receiverId");
//     String sender = senderId.toString();
//     String receiver = receiverId.toString();

//     final receiverResponse =
//         await http.get(Uri.parse('${Constants.fetchchat}'));

//         print('Receiver Response: ${receiverResponse.body}');

//     final senderResponse = await http.get(Uri.parse('${Constants.fetchchat}'));
// print('Sender Response: ${senderResponse.body}');
...
//           .where((message) =>
//               message['sender_id'] == int.parse(receiver) &&
//               message['receiver_id'] == int.parse(sender))
//           .map((message) => Message(
...
//               ))
//           .toList();
// print('Receiver Messages: $receiverMessages');

//       final senderMessages = senderMessagesList
//           .where((message) =>
//               message['sender_id'] == int.parse(sender) &&
//               message['receiver_id'] == int.parse(receiver))
//           .map((message) => Message(
//                 message: message['message'],
